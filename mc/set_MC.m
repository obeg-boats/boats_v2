...
%--------------------------------------------------------
 ...
 MParams = {
		'E_activation_A',	 0.45,	             0.09,          NaN,   NaN,     NaN,     'uniform_spec';
        'E_activation_m',    0.45,	             0.09,          NaN,   NaN,     NaN,     'uniform';
        'b_allo',		     0.7,	             0.125,         NaN,   NaN,     NaN,     'normal';
        'A00',               4.46,	             0.5,           NaN,   NaN,     NaN,     'normal';
        'te',                0.23,	             0.098,         NaN,   NaN,     NaN,     'uniform';
...
%        'sel_slope',         sel_slope_mean,     sel_slope_std, NaN,   NaN,     NaN,     'uniform';
        'sel_pos_scale',     0.75,               0.2,           NaN,   NaN,     NaN,     'uniform';
        'mc_benthic',        -15,                1.55,          NaN,   NaN,     NaN,     'lognormal'};  
